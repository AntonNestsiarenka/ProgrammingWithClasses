package com.company.travelmodel.client.travel_form;
...
public final class TravelFormForSearch {

    /* Класс описывает туристическую форму для клиента туристического агенства. */
